      ...
      return (
        ...
        e.define("select2/results", ["jquery", "./utils"], function (p, h) {
          ...
          return (
            ...
            (r.prototype.render = function () {
              var e = p(
                '<ul className="select2-results__options" role="tree"></ul>'
              );
              return (
            ...
            (r.prototype.displayMessage = function (e) {
              ...
              var n = p(
                  '<li role="treeitem" aria-live="assertive" className="select2-results__option"></li>'
                ),
          ...
          function (n, r, i) {
            ...
            return (
              ...
              (o.prototype.render = function () {
                var e = n(
                  '<span className="select2-selection" role="combobox"  aria-haspopup="true" aria-expanded="false"></span>'
                );
                return (
                  (this._tabindex = 0),
            ...
            return (
              ...
              (i.prototype.render = function () {
                ...
                return (
                  ...
                  e.html(
                    '<span className="select2-selection__rendered"></span><span className="select2-selection__arrow" role="presentation"><b role="presentation"></b></span>'
                  ),
                  e
                );
              }),
            ...
            return (
              ...
              (n.prototype.render = function () {
                ...
                return (
                  ...
                  e.html('<ul className="select2-selection__rendered"></ul>'),
                  e
                );
              }),
              ...
              (n.prototype.selectionContainer = function () {
                return i(
                  '<li className="select2-selection__choice"><span className="select2-selection__choice__remove" role="presentation">&times;</span></li>'
                );
              }),
              ...
              (e.prototype.update = function (e, t) {
                if (
                  ...
                  var n = this.options
                      ...
                      .get("removeAllItems"),
                    r = i(
                      '<span className="select2-selection__clear" title="' +
                        n() +
                        '">&times;</span>'
                    );
          ...
          function (r, s, a) {
            ...
            return (
              (e.prototype.render = function (e) {
                var t = r(
                  '<li className="select2-search select2-search--inline"><input className="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" aria-autocomplete="list" /></li>'
                );
        ...
        e.define("select2/dropdown", ["jquery", "./utils"], function (t, e) {
          ...
          return (
            ...
            (n.prototype.render = function () {
              var e = t(
                '<span className="select2-dropdown"><span className="select2-results"></span></span>'
              );
              return (
          ...
          function (i, e) {
            ...
            return (
              (t.prototype.render = function (e) {
                var t = e.call(this),
                  n = i(
                    '<span className="select2-search select2-search--dropdown"><input className="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" /></span>'
                  );
                return (
        ...
        e.define("select2/dropdown/infiniteScroll", ["jquery"], function (i) {
          ...
          return (
            ...
            (e.prototype.createLoadingMore = function () {
              var e = i(
                  '<li className="select2-results__option select2-results__option--load-more"role="treeitem" aria-disabled="true"></li>'
                ),
          ...
          function (i, c, u, r) {
            ...
            return (
              ...
              (d.prototype.render = function () {
                var e = i(
                  '<span className="select2 select2-container"><span className="selection"></span><span className="dropdown-wrapper" aria-hidden="true"></span></span>'
                );
                return (
